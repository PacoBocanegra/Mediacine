	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center mb-3 titulo"> Panel sesiones </h1>
                        ...
                        <form class="form" method="post">
                            <div class="form-group">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-8">
                                        <input type="date" name="fechaFiltro" class="form-control form-control-sm">
                                    </div>
                                    <div class="col">
                                        <button type="submit" class="btn boton1 btn-sm" name="filtro" value="filtro">Filtrar</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <?php
                    if(isset($noSesiones)) {
                ?>
                    <div class="text-center"> <?php echo $noSesiones; ?> </div>
                <?php
                    }
                ?>
                <?php
                ...
                <div class="row justify-content-center mb-3 fila-panel">
                    <div class="col-5 m-2 bloque-panel">
                    ...
                    <div class="col-1 m-2 p-1 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn boton-panel" name="modificar" value="<?php echo $sesion->getId(); ?>"> 
                    ...
                    <div class="col-1 m-2 p-1 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn boton-panel" name="eliminar" value="<?php echo $sesion->getId(); ?>"> 
