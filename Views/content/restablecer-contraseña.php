...
<html>
	<head>
        ...
        <script type="text/javascript" src="../Views/scripts/restablecer-contraseña.js"></script>
		<!-- Bootstrap CSS -->
	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center titulo">Restablecer contraseña</h1>
                <div class="row justify-content-center">
                    <div class="col-6 text-center p-3 login-registro">
                        <form id="formulario" class="form" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="row justify-content-center">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="email" name="email" id="email" class="form-control form-control-sm" value="<?php if(isset($_POST['email'])){ echo $_POST['email'];} else { echo ''; } ?>" required> 
                                            </div>
                                            <div class="col-md-6">
                                                <label>Anterior contraseña</label>
                                                <input type="text" name="contraseña-anterior" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row justify-content-center">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="contraseña1" id="contraseña1" class="form-control form-control-sm" required> 
                                            </div>
                                            <div class="col-md-6">
                                                <label>Repite contraseña</label>
                                                <input type="text" name="contraseña2" id="contraseña2" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col">
                                    <button type="submit" class="btn boton2" name="restablecer"> Restablecer contraseña </button>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                            <div class="col text-center">
                                <div class="mensaje-error"><?php echo isset($error) ? utf8_decode($error) : '' ; ?></div>
                            </div>
                        </div>
                        </form>
                    </div>
