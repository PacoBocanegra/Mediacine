	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center mb-3 titulo"> Panel películas </h1>
                ...
                <div class="row justify-content-center mb-3 fila-panel">
                    <div class="col-9 m-2 bloque-panel">
                        <p class="text-center"><?php echo $pelicula->getTitle();?></p>
                    </div>
                    <div class="col-1 m-2 p-1 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn boton-panel" name="modificar" value="<?php echo $pelicula->getId();?>"> 
                    ...
                    <div class="col-1 m-2 p-1 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn boton-panel" name="eliminar" value="<?php echo $pelicula->getId();?>"> 
