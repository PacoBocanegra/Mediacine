	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center titulo"><?php if($_SESSION['accion'] == "modificar") { echo "Modificar";} else { echo "Añadir";} ?> sala</h1>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Núm. Sala</label>
                                        <input type="text" name="codigo" class="form-control form-control-sm" value="<?php if(isset($sala)){ echo $sala->getId();} else { if(isset($_POST['codigo'])){ echo $_POST['codigo']; } else { echo ''; } } ?>" required>
                                        <div class="mensaje-error"><?php echo isset($errorID) ? utf8_decode($errorID) : '' ; ?></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Butacas</label>
                                        <input type="number" name="butacas" class="form-control form-control-sm" value="<?php if(isset($sala)){ echo $sala->getSeats();} else { if(isset($_POST['butacas'])){ echo $_POST['butacas']; } else { echo ''; } } ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tipo" class="form-control form-control-sm" value="<?php if(isset($sala)){ echo $sala->getRoomType();} else { if(isset($_POST['tipo'])){ echo $_POST['tipo']; } else { echo ''; } } ?>" required>
                                    </div>
                                </div>
                            </div> 
                            <div class="row justify-content-center">
