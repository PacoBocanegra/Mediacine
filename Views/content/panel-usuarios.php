	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center mb-3 titulo"> Panel usuarios </h1>
                ...
                <div class="row justify-content-center mb-3 fila-panel">
                    <div class="col-1 m-2 bloque-panel <?php if($usuario->getAdmin() == "X"){ echo "usuario-admin"; } ?>">
                        <p class="text-center"><?php echo $usuario->getDNI();?></p>
                    </div>
                    <div class="col m-2 bloque-panel">
                        <p class="text-center"><?php echo $usuario->getEmail();?></p>
                    </div>
                    <div class="col-4 m-2 bloque-panel">
                        <p class="text-center"><?php echo $usuario->getName();?> <?php echo $usuario->getLastName();?></p>
                    </div>
                    <div class="col-1 m-2 p-1 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn boton-panel" name="modificar" value="<?php echo $usuario->getDNI();?>"> 
                    ...
                    <div class="col-1 m-2 p-1 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn boton-panel" name="eliminar" value="<?php echo $usuario->getDNI();?>"> 
