	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center mb-3 titulo"> Panel salas </h1>
                ...
                <div class="row justify-content-center mb-3 fila-panel">
                    <div class="col-2 m-2 bloque-panel">
                        <p class="text-center"><?php echo "Sala " . $sala->getId();?></p>
                    </div>
                    <div class="col-4 m-2 bloque-panel">
                        <p class="text-center"><?php echo $sala->getSeats() . " butacas";?></p>
                    </div>
                    <div class="col-2 m-2 bloque-panel">
                        <p class="text-center"><?php echo $sala->getRoomType();?></p>
                    </div>
                    <div class="col-1 m-2 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn btn-link" name="modificar" value="<?php echo $sala->getId();?>"> 
                    ...
                    <div class="col-1 m-2 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn btn-link" name="eliminar" value="<?php echo $sala->getId();?>"> 
