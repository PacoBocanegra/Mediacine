	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center mb-3 titulo"> Mis reservas </h1>
				<?php
					if(!$reservas) {
				?>
				<div class="row justify-content-center mb-3">
                    <div class="col m-2">
                        <p class="text-center">No tienes ninguna reserva por el momento.</p>
                    </div>
                </div>
                <?php
					} else {
                ...
                <div class="row justify-content-center mb-3 fila-panel">
                    ...
                    <div class="col-2 m-2 bloque-panel">
                        <p class="text-center">Entradas: <?php echo $reserva->getNumSeat(); ?></p>
                    </div>
                    <div class="col-1 m-2 bloque-panel">
                        <p class="text-center"><?php echo $tarifa->getPrice();?>€/u</p>
                    </div>
                </div>
                <?php
						}
