	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center titulo"><?php if($_SESSION['accion'] == "modificar") { echo "Modificar";} else { echo "Añadir";} ?> tarifa</h1>
                <div class="row justify-content-center">
                    <div class="col-10 text-center p-3 login-registro">
                        ...
                        <input type="hidden" name="codigo" class="form-control form-control-sm" value="<?php if(isset($tarifa)){ echo $tarifa->getId();} else { if(isset($_POST['codigo'])){ echo $_POST['codigo']; } else { echo ''; } } ?>">
                            <div class="row justify-content-center">
                                <div class="col-8">
                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <input type="text" name="descripcion" class="form-control form-control-sm" value="<?php if(isset($tarifa)){ echo $tarifa->getType();} else { if(isset($_POST['descripcion'])){ echo $_POST['descripcion']; } else { echo ''; } } ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Precio</label>
                                        <input type="text" name="precio" class="form-control form-control-sm" value="<?php if(isset($tarifa)){ echo $tarifa->getPrice();} else { if(isset($_POST['precio'])){ echo $_POST['precio']; } else { echo ''; } } ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
