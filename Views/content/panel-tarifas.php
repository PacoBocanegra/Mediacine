	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center mb-3 titulo"> Panel tarifas </h1>
                ...
                <div class="row justify-content-center mb-3 fila-panel">
                    <div class="col-8 m-2 bloque-panel">
                        <p class="text-center"><?php echo $tarifa->getType();?></p>
                    </div>
                    <div class="col-1 m-2 bloque-panel">
                        <p class="text-center"><?php echo $tarifa->getPrice();?>€</p>
                    </div>
                    <div class="col-1 m-2 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn btn-link" name="modificar" value="<?php echo $tarifa->getId();?>"> 
                    ...
                    <div class="col-1 m-2 text-center bloque-panel">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <button type="submit" class="btn btn-link" name="eliminar" value="<?php echo $tarifa->getId();?>"> 
