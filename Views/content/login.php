                ...
                <div class="row justify-content-center">
                    <div class="col-6 text-center p-3 login-registro">
                        <form class="form" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                            <div class="row justify-content-center">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control form-control-sm" value="<?php if(isset($_POST['email'])){ echo $_POST['email'];} else { echo ''; } ?>" required focus>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 mb-3">
                                                <input type="password" name="contraseña" id="contraseña" class="form-control form-control-sm" required> 
                                            </div>
                                            <div class="col-md-2">
                                                <button class="btn icon-eye" type="button" id="ojo"></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col mb-3">
                                    <button type="submit" class="btn boton2" name="acceder"> Acceder </button>
                                </div>
                            </div>
                        </form>
                        <div class="row justify-content-center">
                        ...
                        <form class="form" method="post">
                            <div class="row justify-content-center mt-3">
                                <div class="col-md mb-3">
                                    <button type="submit" class="btn boton2" name="registro"> Registrarse </button>
                                </div>
                                <div class="col-md mb-3">
                                    <button type="submit" class="btn boton2" name="restablecer-contra"> Restablecer contraseña </button>
                                </div>
                            </div>
                        </form>
                    </div>
