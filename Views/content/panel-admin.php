	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center mb-3 titulo"> Panel administrador </h1>
                <div class="row justify-content-center">
                    <div class="col-lg-2 col-md-4 m-3 text-center boton-panel-admin" id="panel-peliculas">
                        <p class="icon-video-camera icono-panel"></p>
                        <p>Películas</p>
                    </div>
                    <div class="col-lg-2 col-md-4 m-3 text-center boton-panel-admin" id="panel-sesiones">
                        <p class="icon-clock icono-panel"></p>
                        <p>Sesiones</p>
                    </div>
                    <div class="col-lg-2 col-md-4 m-3 text-center boton-panel-admin" id="panel-tarifas">
                        <p class="icon-eur icono-panel"></p>
                        <p>Tarifas</p>
                    </div>
                    <div class="col-lg-2 col-md-4 m-3 text-center boton-panel-admin" id="panel-usuarios">
                        <p class="icon-user icono-panel"></p>
                        <p>Usuarios</p>
					</div>
					<div class="col-lg-2 col-md-4 m-3 text-center boton-panel-admin" id="panel-salas">
                        <p class="icon-airplay icono-panel"></p>
                        <p>Salas</p>
					</div>
					<div class="col-lg-2 col-md-4 m-3 text-center boton-panel-admin" id="panel-reservas">
                        <p class="icon-ticket icono-panel"></p>
                        <p>Reservas</p>
					</div>
					<div class="col-lg-2 col-md-4 m-3 text-center boton-panel-admin" id="panel-valoraciones">
                        <p class="icon-star icono-panel"></p>
                        <p>Valoraciones</p>
                    </div>
                </div>
			</div>
