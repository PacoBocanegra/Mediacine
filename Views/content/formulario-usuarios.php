	...
	<body class="cuerpo">
		<div class="container">
		    ...
		    <div class="contenido p-3">
                <h1 class="text-center titulo"><?php if($_SESSION['accion'] == "modificar") { echo "Modificar";} else { echo "Añadir";} ?> usuario</h1>
                        ...
                        <form id="formulario" action="<?php $_SERVER['PHP_SELF']; ?>" class="form" method="post">
                            <div class="row justify-content-center">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>DNI</label>
                                        <input type="text" name="dni" class="form-control form-control-sm" value="<?php if(isset($usuario)){ echo $usuario->getDNI();} else { if(isset($_POST['dni'])){ echo $_POST['dni']; } else { echo ''; } } ?>" required>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" class="form-control form-control-sm" value="<?php if(isset($usuario)){ echo $usuario->getEmail();} else { if(isset($_POST['email'])){ echo $_POST['email']; } else { echo ''; } } ?>"required>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" name="nombre" class="form-control form-control-sm" value="<?php if(isset($usuario)){ echo $usuario->getName();} else { if(isset($_POST['nombre'])){ echo $_POST['nombre']; } else { echo ''; } } ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Apellidos</label>
                                        <input type="text" name="apellidos" class="form-control form-control-sm" value="<?php if(isset($usuario)){ echo $usuario->getLastName();} else { if(isset($_POST['apellidos'])){ echo $_POST['apellidos']; } else { echo ''; } } ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" class="form-control form-control-sm" value="<?php if(isset($usuario)){ echo $usuario->getPwd();} else { if(isset($_POST['password'])){ echo $_POST['password']; } else { echo ''; } } ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label>Admin</label>
                                    <div class="table-responsive">
                                        <table class="table tabla-usuario text-center">
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input type="radio" name="admin" class="form-check-input form-check-input-sm" value="si" required <?php if(isset($usuario)) { if($admin == "X") {echo "checked";}} ?>>
                                                        <label class="form-check-label">Sí</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check">
                                                        <input type="radio" name="admin" class="form-check-input form-check-input-sm" value="no" required <?php if(isset($usuario)) { if($admin == "" || $admin == "NULL") {echo "checked";}} ?>>
